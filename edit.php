...
if (isset($_SESSION['admin_login'])) {
    ...
    $message   =  "";
        ...
        $edit = mysqli_query($connection,"SELECT * FROM fixture_player WHERE ID = '$id' ");
    ...
    if(count($_POST)>0)
    {
      ...
      $sql=mysqli_query($connection,"UPDATE fixture_player SET Schedule_ID = '$Schedule', Team_ID = '$Team',Lineup_ID='   $Lineup',Player_ID='$Player' WHERE ID = '$ID'");
      if ($sql) {
...
<head>
  ...
  <title>Footballstat | Edit Lineup</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit Lineup</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit Lineup</h5>
              ...
              <div class="container"> 
                  ...
                  <form method="post" action="edit.php">
                        ...
                        <div class="col-md-6">
                          <label for="">Role</label>
                            <select name="Lineup" class="form-control">
                              ...
                              <option value="<?php echo $key['ID']; ?>"<?php if($row['Lineup_ID'] == $key['ID']) echo 'selected="selected"'; ?>><?php echo $key['Lineup']; ?></option>
                              <?php endforeach;?>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <hr>
                        <a href="insert.php" class="btn btn-secondary">Go Back</a>
