...
if (isset($_SESSION['admin_login'])) {
    ...
    $message   =  "";
        ...
        $edit = mysqli_query($connection,"SELECT * FROM fixture_event WHERE Fixture_Event_ID = '$id' ");
    ...
    if(count($_POST)>0)
    {
      ...
      $sql=mysqli_query($connection,"UPDATE fixture_event SET Schedule_ID = '$Schedule', Team_ID = '$Team', Event_ID='   $Event',Player_ID='$Player',Minute='$Minute' WHERE Fixture_Event_ID = '$ID'");
      if ($sql) {
...
<head>
  ...
  <title>Footballstat | Edit Event</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="home.php">Home</a></li>
          <li class="breadcrumb-item active"><a href="insert_event.php">Insert Event</a></li>
            ...
            <div class="card-body">
              ...
              <div class="container"> 
                  ...
                  <form method="post" action="edit_event.php">
                        ...
                        <div class="col-md-6">
                        <input type="text" readonly value="<?php echo $row['Fixture_Event_ID']; ?>" required class="form-control" name="IDI" >
                        </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <select name="Player" class="form-control selectpicker" data-live-search="true">
                              <option>Please select Player</option>
                              <?php foreach($result4 as $key ):?>
                              <option value="<?php echo $key['Player_ID']; ?>"<?php if($row['Player_ID'] == $key['Player_ID']) echo 'selected="selected"'; ?>><?php echo $key['Player_Name']; ?></option>
                              <?php endforeach;?>
                        ...
                        <div class="col-md-6">
                          <label for="">Event</label>
                            <select name="Event" class="form-control">
                              ...
                              <option value="<?php echo $key['Event_ID']; ?>"<?php if($row['Event_ID'] == $key['Event_ID']) echo 'selected="selected"'; ?>><?php echo $key['Event_Name']; ?></option>
                              <?php endforeach;?>
                            </select>
                        </div>
                        ...
                        <hr>
                        <a href="insert_event.php" class="btn btn-secondary">Go Back</a>
