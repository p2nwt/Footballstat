<?php
  ...
  if (isset($_SESSION['admin_login'])) {
    ...
    if (isset($_GET['delete'])) {
      ...
      $deletestmt = $conn->query("DELETE FROM fixture_event WHERE Fixture_Event_ID = $delete_id");
      $deletestmt->execute();

      if ($deletestmt) {
          echo "<script>alert('Data has been deleted successfully');</script>";
          $_SESSION['success'] = "Data has been deleted succesfully";
          header("refresh:1; url=insert_event.php");
      }
...
<head>
  ...
  <title>Football Stat | Insert Event</title>
                  ...
                  <form method="post" action="insert_event.php">
                        ...
                        <div class="col-md-6">
                          <label for="">Event</label>
                            <select name="Event" class="form-control selectpicker" data-live-search="true">
          ...
          <h5 class="card-title">Show Data</h5>
            ...
            <?php 
                    ...
                    <td><?php echo $user['Minute']; ?></td>
                        <td>
                            <a href="edit_event.php?id=<?php echo $user['ID']; ?>" class="badge bg-info text-dark">Edit</a>
