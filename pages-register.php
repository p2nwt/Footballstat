...
<head>
  ...
  <title>Footballstat | Register</title>
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="firstname" class="form-control" aria-describedby="firstname" >
                    
                    </div>
                    
                    <div class="col-12">
                      <label for="lastname" class="form-label">Your Last name</label>
                      <input type="text" name="lastname" class="form-control" aria-describedby="lastname" >
                    ...
                    <div class="col-12">
                      <button name="signup" class="btn btn-primary w-100" type="submit">Create Account</button>
                    </div>  
