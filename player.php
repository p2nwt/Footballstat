    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="home.php">Home</a></li>
          <li class="breadcrumb-item active"><a href="player.php">Players</a></li>
                            ...
                            ORDER BY 
                              ...
                              ?>
                                  <tr>
                                      ...
                                      <td> <img width="75" src="assets/img/<?php echo $user['playerpng'];?>"> <?php echo "<a href='player_info.php?id={$user['ID']}'style='text-decoration:none'>" . $user["Player"] . "</a>" ;?></td>
