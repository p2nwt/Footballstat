    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="home.php">Home</a></li>
          <li class="breadcrumb-item active"><a href="static.php">Statics</a></li>
              ...
              <table class="table ">
                          ...
                          <?php 
                              ...
                              ?>
                                  ...
                                  <tr>
                                      <td><?php echo $pos ?></td>
                                      <td> <img width="80" src="assets/img/<?php echo $user['Pic'];?>"><?php echo "<a href='player_info.php?id={$user['ID']}'style='text-decoration:none'>" . $user["Player"] . "</a>" ;?></td>
                                      <td> <?php echo "<a href='team_info.php?id={$user['TeamID']}'style='text-decoration:none'>" . $user["Team"] . "</a>" ;?></td>
              ...
              <table class="table ">
                          ...
                          <?php 
                              ...
                              ?>
                                  ...
                                  <tr>
                                      <td><?php echo $pos ?></td>
                                      <td> <img width="60" src="assets/img/<?php echo $user['Logo'];?>"> <?php echo "<a href='team_info.php?id={$user['TeamID']}'style='text-decoration:none'>" . $user["Team"] . "</a>" ;?></td>   
