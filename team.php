    ...
    <div class="pagetitle">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="home.php">Home</a></li>
          <li class="breadcrumb-item active"><a href="team.php">Clubs</a></li>
              ...
              <div class="col-3">
                ...
                <div class="card info-card sales-card">
                  <div class="card-body">
                    ...
                    <h5 class="card-title" style="vertical-align:middle;margin:10px 10px "><?php echo "<a href='team_info.php?id={$row['ID']}'style='text-decoration:none'>" . $row["Name"] . "</a>" ;?>
