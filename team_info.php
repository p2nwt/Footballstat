    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="team.php">Club</a></li>
          <li class="breadcrumb-item active"><?php echo "<a href='team_info.php?id={$key['ID']}'style='text-decoration:none'>" . $key["Name"] . "</a>" ;?></li>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  <div class="col-lg-12"> 
                    ...
                    <div class="col-3">
                      <div class="card info-card sales-card">
                        <div class="card-body">
                          <h5 class="card-title" style="vertical-align:middle;margin:10px 10px "><?php echo "<a href='player_info.php?id={$row1['ID']}'style='text-decoration:none'>" . $row1["Name"] . "</a>" ;?>
