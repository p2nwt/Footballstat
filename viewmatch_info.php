    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="viewmatch.php">Match</a></li>
              ...
              <div class="col-12">
                ...
                <h5 class="card-title" style=" margin:0px 20px">Matchday <?php echo $key["Matchday"];?> <span>| NO. <?php echo $key["Number"];?></span></h5>
                  <div class="d-flex flex-column align-items-center">
                    <h5 class="card-title" ><?php echo "<a href='viewteam_info.php?id={$key['Home_ID']}'style='text-decoration:none'>" . $key["Home_Team"]  ."</a>" ;?>
                    <span>VS</span>  <?php echo "<a href='viewteam_info.php?id={$key['Away_ID']}'style='text-decoration:none'>" . $key["Away_Team"] . "</a>" ;?>
                  </div>
                  <div class="d-flex flex-column align-items-center">
                  <div class=" d-flex flex-column align-items-center">
                      ...
                      <?php 
                              ...
                              ?>
                                  <tr>
                                      ...
                                      <td> <img width="60" src="assets/img/<?php echo $user['playerpng'];?>"> <?php echo "<a href='viewplayer_info.php?id={$user['pID']}'style='text-decoration:none'>" . $user["Player"] . "</a>" ;?></td>
              ...
              <div class="tab-content pt-2" id="myTabContent">
                ...
                <?php 
                              ...
                              ?>
                                  <tr>
                                      <td><?php echo $user['Number']; ?></td>
                                      <td> <img width="60" src="assets/img/<?php echo $user['playerpng'];?>"> <?php echo "<a href='viewteam_info.php?id={$user['pID']}'style='text-decoration:none'>" . $user["Player"] . "</a>" ;?></td>
            ...
            <?php 
                              ...
                              ?>
                                  <tr>
                                      ...
                                      <td> <img width="40" src="assets/img/<?php echo $user['playerpng'];?>"> <?php echo "<a href='viewplayer_info.php?id={$user['PlayerID']}'style='text-decoration:none'>" . $user["Player"] . "</a>" ;?></td>

                                      
                                      <td> <img width="40" src="assets/img/<?php echo $user['teampng'];?>"> <?php echo "<a href='viewteam_info.php?id={$user['TeamID']}'style='text-decoration:none'>" . $user["Team"] . "</a>" ;?></td>
            ...
            <?php 
                              ...
                              ?>
                                  <tr>
                                      ...
                                      <td> <img width="40" src="assets/img/<?php echo $user['player1png'];?>"> <?php echo "<a href='viewplayer_info.php?id={$user['PID1']}'style='text-decoration:none'>" . $user["PlayerIn"] . "</a>" ;?></td>
                                      <td> <img width="40" src="assets/img/<?php echo $user['player2png'];?>"> <?php echo "<a href='viewplayer_info.php?id={$user['PID2']}'style='text-decoration:none'>" . $user["PlayerOut"] . "</a>" ;?></td>
