    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="viewplayer.php">Player</a></li>
            ...
            <div class="col-sm-4">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="ps-6">
                      <span class="text-dark normal pt-1 fw-bold">CLUB :</span> <span class="text-muted big pt-2 ps-1"><?php echo "<a href='viewteam_info.php?id={$key['TeamID']}'style='text-decoration:none'>" . $key["Club"] . "</a>" ;?></span>
                  </div>
                  <div class="ps-6">
